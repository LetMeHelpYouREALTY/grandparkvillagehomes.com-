...
Dr. Jan's approach is simple: treat every client like family, know the market inside and out, and never stop working until the deal closes successfully.`,
  ...
  whereWeServe: `Dr. Jan serves the entire Las Vegas Valley with specialized knowledge of Las Vegas, Summerlin, Henderson, North Las Vegas, and all of Clark County. Neighborhood expertise includes Summerlin's master-planned communities and Grand Park Village Homes in West Summerlin, Henderson's Green Valley and Inspirada, the luxury enclaves of The Ridges and Southern Highlands, Centennial Hills and Skye Canyon, and affordable options in Mountains Edge and North Las Vegas.
...
Office located at 9406 W Lake Mead Blvd, Suite 100, Las Vegas, NV 89134. Available Monday through Friday 9am-6pm, Saturday 10am-4pm, and Sunday by appointment. Call (702) 500-1942 for a free consultation or visit grandparkvillagehomes.com to start your Las Vegas real estate journey today.`,
};
...
export function generateLocalBusinessSchema() {
  return {
    ...
    "@id": "https://www.grandparkvillagehomes.com/#organization",
    name: businessInfo.name,
    image: "https://www.grandparkvillagehomes.com/images/dr-jan-duffy.jpg",
