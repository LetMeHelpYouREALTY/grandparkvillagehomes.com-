...
export const FAQ_BY_PAGE_TYPE: Record<string, FAQ[]> = {
  ...
  lifestyle: [
    ...
    { question: "What Las Vegas neighborhoods are most popular with California relocators?",
      answer: "Summerlin is a frequent choice — master-planned, with parks and trails, and reminiscent of suburban California. Henderson's Green Valley and MacDonald Ranch are strong seconds. Both offer top-tier amenities, newer construction, and easy airport access for those still traveling back to California for work." },
    ...
    { question: "Is Las Vegas a good place to raise a family?",
      answer: "Absolutely — especially in master-planned communities. Summerlin, Henderson, and North Las Vegas have parks and recreation centers. Which school serves a home depends on the address. Many buyers get more square footage here than in California or the Pacific Northwest." },
